...
SCHEMA_PATH = Path('/home/exit/proyectos/DockerDashboard/Backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/exit/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    dockercontainer: 'actions.DockerContainerActions[models.DockerContainer]'
    logentry: 'actions.LogEntryActions[models.LogEntry]'
    ...
    def __init__(
        ...
        *,
        ...
        self.dockercontainer = actions.DockerContainerActions[models.DockerContainer](self, models.DockerContainer)
        self.logentry = actions.LogEntryActions[models.LogEntry](self, models.LogEntry)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/exit/proyectos/DockerDashboard/Backend/prisma/schema.prisma',
        }
...
class Batch:
    dockercontainer: 'DockerContainerBatchActions'
    logentry: 'LogEntryBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.dockercontainer = DockerContainerBatchActions(self)
        self.logentry = LogEntryBatchActions(self)
...
class DockerContainerBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.DockerContainerCreateInput,
        include: Optional[types.DockerContainerInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.DockerContainer,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.DockerContainerCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.DockerContainerWhereUniqueInput,
        include: Optional[types.DockerContainerInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.DockerContainerUpdateInput,
        where: types.DockerContainerWhereUniqueInput,
        include: Optional[types.DockerContainerInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.DockerContainerWhereUniqueInput,
        data: types.DockerContainerUpsertInput,
        include: Optional[types.DockerContainerInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.DockerContainerUpdateManyMutationInput,
        where: types.DockerContainerWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.DockerContainer,
    ...
    def delete_many(
        self,
        where: Optional[types.DockerContainerWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.DockerContainer,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class LogEntryBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.LogEntryCreateInput,
        include: Optional[types.LogEntryInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.LogEntryCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.LogEntryWhereUniqueInput,
        include: Optional[types.LogEntryInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.LogEntryUpdateInput,
        where: types.LogEntryWhereUniqueInput,
        include: Optional[types.LogEntryInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.LogEntryWhereUniqueInput,
        data: types.LogEntryUpsertInput,
        include: Optional[types.LogEntryInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.LogEntryUpdateManyMutationInput,
        where: types.LogEntryWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.LogEntry,
    ...
    def delete_many(
        self,
        where: Optional[types.LogEntryWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.LogEntry,
