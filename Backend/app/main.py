...
from app.metrics_collector import schedule_metrics_collection, clean_old_metrics
import asyncio
...
async def startup():
    ...
    asyncio.create_task(schedule_metrics_collection())
    asyncio.create_task(clean_old_metrics())
